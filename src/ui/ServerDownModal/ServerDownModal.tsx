            ...
            <div className="server-down-modal-ui-component">
                <div ref={modal} className="modal">
                    ...
                    <div className="text">
                        ...
                        <p>The Websocket Server is currently down. Because of this, most of the website will no longer function properly. Please return at {serverUpAt} to properly use the website.</p>
